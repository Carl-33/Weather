...
$(document).ready(function () {
    ...
    // var pastSearces = JSON.parse(localStorage.getItem("searches"))
    // console.log(pastSearces)
    ...
    function displayWeather() {
        ...
        var queryCity = localSearches[localSearches.length - 1];
        // queryCity = searches[searches.length - 1];
    ...
    $("#add-city").on("click", function (event) {
        ...
        // var pastSearches = localStorage.getItem(JSON.parse("searches"))
        $("#past-searches").empty();
        displayWeather();
    ...
    if (pastSearches == null) {
        ...
        console.log(pastSearches[0])
        console.log(pastSearches[1])
